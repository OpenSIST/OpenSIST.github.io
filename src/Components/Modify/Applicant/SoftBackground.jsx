...
function SoftBackground({formValues, handleBack, handleChange}) {
    ...
    return (
        ...
        >
            ...
            <Divider textAlign="left">科研经历</Divider>
            <Grid
                container
                spacing={2}
                sx={{width: '80%', justifyContent: 'center', margin: 0}}
            ...
            <Divider textAlign="left">实习经历</Divider>
            <Grid
                container
                spacing={2}
                sx={{width: '80%', justifyContent: 'center', margin: 0}}
            ...
            <Divider textAlign="left">论文发表</Divider>
            <Button onClick={handleAddPublication} variant="contained">
                <Add/>
            </Button>
            ...
            <Divider textAlign="left">推荐信</Divider>
            ...
            <Divider textAlign="left">竞赛经历</Divider>
            <Grid
                container
                spacing={2}
                sx={{width: '80%', justifyContent: 'center', margin: 0}}
