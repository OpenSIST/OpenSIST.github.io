...
export function AboutUs({sx = {}}) {
    ...
    return (
        <Box sx={{width: '100%', ...sx}}>
            <Typography variant='h6' sx={{fontWeight: 600, mb: 1.5}}>我们是谁？（按姓氏排序）</Typography>
            ...
            <Typography variant='h6' sx={{fontWeight: 600, mt: 3.5, mb: 1}}>为何创立<OpenSIST props={{variant: 'h6'}}/>？</Typography>
            <Typography sx={{color: 'text.secondary', lineHeight: 1.9}}>
                ...
                因此针对这个问题，我们借鉴<a href='https://opencs.app/'>OpenCS</a>和<a href='https://global-cs-application.github.io/'>Global CS</a>的设计，希望能够为学弟学妹们提供专属于上科大的更加透明的申请信息平台，让大家能够更加清晰地了解往届学生的申请情况，从而更好地规划自己的申请策略。
            </Typography>

            <Typography variant='h6' sx={{fontWeight: 600, mt: 3.5, mb: 1}}>联系我们</Typography>
            <Typography sx={{color: 'text.secondary', lineHeight: 1.9, mb: 1}}>
                <b>如果您愿意参与OpenSIST后续的前端/后端维护工作，欢迎加入<a href='https://qm.qq.com/q/NyTIRw8PGC'>开发者QQ群：766590153</a>联系我们，大二以上非毕业生优先（包括研究生）</b>
            </Typography>
            <Typography sx={{color: 'text.secondary', lineHeight: 1.9}}>
                如果您在使用中遇到了问题，欢迎前往<a href='https://github.com/OpenSIST/OpenSIST.github.io/issues'>GitHub Official Repository</a>中提出Issue。
            </Typography>
        </Box>
    );
}
