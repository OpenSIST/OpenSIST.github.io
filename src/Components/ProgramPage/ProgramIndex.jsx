...
const tips = [
    ...
    },
    {
        ...
        title: "贡献项目",
        desc: "点击「学校列表」右上角的「+」添加新项目，或在项目页补充完善信息，与大家共同维护数据。",
    },
    {
    ...
    },
    {
        icon: <InfoOutlined/>,
        title: "专业标签",
        desc: "项目卡片上的专业标签表示哪些专业的学生可申请该项目，含义见下方速查表。",
    },
];
    ...
    return (
        <Box sx={{flex: 1, minHeight: 0, overflowY: "auto", width: "100%", py: {xs: 1, sm: 2}}}>
            ...
            <Typography sx={{color: "text.secondary", mt: 1, mb: 4, maxWidth: 720}}>
                汇集 ShanghaiTech 学长学姐整理的海外硕博项目信息，涵盖项目方向、目标专业与申请要点。
                从左侧选择学校开始浏览，或借助筛选快速定位目标项目。
            </Typography>
            ...
            <Box sx={{mt: 4}}>
                ...
                >
                    <Box component="ul" sx={{m: 0, pl: 2.5, color: "text.secondary"}}>
                        {notes.map((note) => (
                            <Typography component="li" variant="body2" key={note} sx={{lineHeight: 1.9}}>
                                {note}
                            </Typography>
                        ))}
                    </Box>
                    <Typography variant="body2" sx={{color: "text.secondary", mt: 1.5, lineHeight: 1.8}}>
                        没有找到你的学校？请到 GitHub{" "}
                        <MuiLink href="https://github.com/orgs/OpenSIST/discussions/23" target="_blank" rel="noopener">
                            Discussion
                        </MuiLink>{" "}
